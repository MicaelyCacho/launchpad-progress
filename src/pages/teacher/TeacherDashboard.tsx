...
export const TeacherDashboard: React.FC = () => {
  ...
  const classStats = [
    { turma: 'Turma A', media: 85, alunos: 25 },
    { turma: 'Turma B', media: 78, alunos: 22 },
    { turma: 'Turma C', media: 82, alunos: 28 },
  ];

  const competencyStats = [
    { competencia: 'Argumentação', turmaA: 85, turmaB: 78, turmaC: 82 },
    { competencia: 'Coesão', turmaA: 80, turmaB: 75, turmaC: 79 },
    { competencia: 'Gramática', turmaA: 88, turmaB: 82, turmaC: 85 },
    { competencia: 'Repertório', turmaA: 82, turmaB: 76, turmaC: 80 },
    { competencia: 'Proposta', turmaA: 86, turmaB: 80, turmaC: 83 }
  ];

  const monthlyProgress = [
    { mes: 'Jan', turmaA: 75, turmaB: 70, turmaC: 72 },
    { mes: 'Fev', turmaA: 78, turmaB: 73, turmaC: 75 },
    { mes: 'Mar', turmaA: 82, turmaB: 75, turmaC: 78 },
    { mes: 'Abr', turmaA: 85, turmaB: 78, turmaC: 82 },
  ];
  ...
  const handleCreateRoom = () => {
    if (newRoomName.trim()) {
      // Aqui seria implementada a lógica para criar uma nova sala
      ...
      <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Card className="border-launch-beige-light">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">+2.3 pontos este mês</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Tabs defaultValue="notas" className="w-full">
          <TabsList className="grid w-full grid-cols-4">
            ...
            <TabsTrigger value="conteudos">Gerenciar Conteúdos</TabsTrigger>
            <TabsTrigger value="solicitacoes">Solicitações</TabsTrigger>
            <TabsTrigger value="nova-sala">Nova Sala</TabsTrigger>
          </TabsList>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card className="border-launch-beige-light">
                <CardHeader>
                  ...
                  <CardDescription>Desempenho detalhado por turma</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card className="border-launch-beige-light">
                <CardHeader>
                  ...
                  <CardDescription>Progresso mensal por turma</CardDescription>
                </CardHeader>
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
          ...
          {/* Aba de Nova Sala */}
          <TabsContent value="nova-sala" className="space-y-6">
